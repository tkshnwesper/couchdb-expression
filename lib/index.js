    ...
    _createClass(CouchDBStore, [{
      ...
      value: function get(sid, callback) {
        ...
        this.execute(function (db) {
          db.get(_this3.sidToCid(sid), function (err, doc) {
            if (err) {
      ...
      value: function set(sid, session, callback) {
        ...
        this.execute(function (db) {
          return (
             ...
             * with an underscore.
             */
            db.insert(session, _this4.sidToCid(sid), function (err) {
              if (err && _this4.setErrorCount < 3) {
                _this4.setErrorCount++;
                 ...
                 */
                _this4.get(sid, function (err, doc) {
                  return _this4.set(sid, _extends({}, session, { _rev: doc._rev }), callback);
                });
              } else {
                _this4.setErrorCount = 0;
                callback(err);
              }
            })
          );
      ...
      value: function destroy(sid, callback) {
        ...
        this.get(sid, function (err, doc) {
          return _this5.execute(function (db) {
